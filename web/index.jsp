<% 
    ...
    if(name.equals("akshat05")&&password.equals("12345"))
    {
...
<div class="login">
  ...
  <form name="myForm" method="post" class="login-container">
      <p><input type="text" name="n1" id="name" required placeholder="Username"></p>
      <p><input type="password" name="p1" id="password" required placeholder="Password"></p>
